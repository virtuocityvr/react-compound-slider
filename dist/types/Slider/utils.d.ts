...
export declare function getSortByVal(reversed?: boolean): (a: HandleItem, b: HandleItem) => 1 | 0 | -1;
...
export declare function getHandles(values: number[] | undefined, reversed: boolean, valueToStep: DiscreteScale, warn: boolean): {
    handles: {
        key: string;
        val: number;
    }[];
