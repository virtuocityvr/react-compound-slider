...
var Ticks = React.memo(function (_ref) {
...
function (_PureComponent) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      return flatten ? React.createElement(React.Fragment, null, React.createElement(Comp, _objectSpread2({}, rootProps, {
        style: rootStyle,
        className: className,
        ref: this.slider
      })), children) : React.createElement(React.Fragment, null, React.createElement(Comp, _objectSpread2({}, rootProps, {
        style: rootStyle,
        className: className,
        ref: this.slider
      }), children));
