...
function (_Component) {
  ...
  function Rail() {
    ...
    _this.getRailProps = function (props) {
...
function (_Component) {
  ...
  function Handles() {
    ...
    _this.getHandleProps = function (id, props) {
      var _this$props = _this.props,
          emitKeyboard = _this$props.emitKeyboard,
          emitMouse = _this$props.emitMouse,
          emitTouch = _this$props.emitTouch;
      return _objectSpread2({}, props, {
        onKeyDown: callAll(props && props.onKeyDown, //@ts-ignore
        function (e) {
          return emitKeyboard(e, id);
        }),
        onMouseDown: callAll(props && props.onMouseDown, _this.autofocus, //@ts-ignore
        function (e) {
          return emitMouse(e, id);
        }),
        onTouchStart: callAll(props && props.onTouchStart, //@ts-ignore
        function (e) {
...
var Ticks = React__default.memo(function (_ref) {
  var children = _ref.children,
      values = _ref.values,
      _ref$scale = _ref.scale,
      scale = _ref$scale === void 0 ? new LinearScale() : _ref$scale,
      _ref$count = _ref.count,
      count = _ref$count === void 0 ? 10 : _ref$count,
      _ref$getEventData = _ref.getEventData,
      getEventData = _ref$getEventData === void 0 ? defaultGetEventData : _ref$getEventData,
      _ref$activeHandleID = _ref.activeHandleID,
      activeHandleID = _ref$activeHandleID === void 0 ? '' : _ref$activeHandleID;
...
function (_PureComponent) {
  ...
  function Slider() {
    ...
    _this.slider = React__default.createRef();
    ...
    _this.onMouseUp = function () {
      ...
      if (isBrowser) {
        var doc = _this.props.document || document;
    ...
    _this.onTouchEnd = function () {
      ...
      if (isBrowser) {
        var doc = _this.props.document || document;
        doc.removeEventListener('touchmove', _this.onTouchMove);
        doc.removeEventListener('touchend', _this.onTouchEnd);
      }
    };
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      return flatten ? React__default.createElement(React__default.Fragment, null, React__default.createElement(Comp, _objectSpread2({}, rootProps, {
        style: rootStyle,
        className: className,
        ref: this.slider
      })), children) : React__default.createElement(React__default.Fragment, null, React__default.createElement(Comp, _objectSpread2({}, rootProps, {
        style: rootStyle,
        className: className,
        ref: this.slider
      }), children));
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      var _nextProps$step = nextProps.step,
          ...
          domain = _nextProps$domain === void 0 ? [0, 100] : _nextProps$domain,
